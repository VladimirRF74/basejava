                ...
                <c:when test="${type=='EXPERIENCE' || type=='EDUCATION'}">
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>">
                        <div class="section-wrapper">
                            ...
                            <c:forEach var="position" items="${org.specialisations}">
                                <jsp:useBean id="position" type="com.urise.webapp.model.Organization.Specialisation"/>
                                <div class="period-position">
                                    <div class="period">
                                        <p><%=DateUtil.format(position.getStartDate())%><br>
                                        <%=DateUtil.format(position.getEndDate())%></p>
                                    </div>
