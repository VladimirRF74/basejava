...
<%--                            <button class="green-button">Добавить</button>--%>
                            ...
                            <input class="field" type="text" placeholder="Название" name='${type}' size=100 value="${org.link.name}">
                            <input class="field" type="text" placeholder="Ссылка" name='${type}url' size=100 value="${org.link.url}">
